...
https://raw.githubusercontent.com/tensorflow/hub/master/examples/text_embeddings_v2/export_v2.py
...
def main(_):
  export_module_from_file(FLAGS.embedding_file, FLAGS.export_path,
                          FLAGS.num_oov_buckets, FLAGS.num_lines_to_ignore,
