...
![image-20210524173147207](images/image-20210524173147207.png)

![image-20210524173202428](images/image-20210524173202428.png)
...
> 核函数可以很大程度上简化计算量，这是因为计算量的关键参数从$D$（可能是无限维）变到了$n$。然后这带来新的问题，当$n$非常大的时候，计算量会急剧增加，所以一般KPCA更加适用于样本数不是很大的数据集。同样的同理，运用核函数的SVM算法，当样本数据量大一些的时候，也是非常的慢。
...
![如何制作不开裂的瑞士卷蛋糕基本卷蛋糕食谱简易卷蛋糕_哔哩哔哩(゜-゜)つロ干杯~-bilibili](images/b5d6a48db3fd896d401612ccfbf586543dbd2bfe.jpg@336w_190h_1c.webp)
...
<img src="images/image-20210525104005185.png" alt="image-20210525104005185" style="zoom:80%;" />![image-20210525104103158](images/image-20210525104103158.png)
