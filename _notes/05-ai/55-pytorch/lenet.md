...
![image-20201023143543068](images/image-20201023143543068.png)
...
![image-20201023144728125](images/image-20201023144728125.png)
...
~~~python
def train_evaluate(model, save_model=False):   
    print("-"*50 + "\n显示参数")
    model.summary()
...
train_evaluate(model, save_model=True)
~~~
...
![image-20201023151845160](images/image-20201023151845160.png)
...
![image-20201023152113051](images/image-20201023152113051.png)
...
![image-20201023152944633](images/image-20201023152944633.png)
...
![image-20201023153143015](images/image-20201023153143015.png)

![image-20201023153157849](images/image-20201023153157849.png)
...
def lenet2(in_dim=1, n_class=10):
    model = models.Sequential()
    model.add(layers.Conv2D(6, (5, 5), activation='relu', padding='same', input_shape=(32, 32, in_dim)))
    model.add(layers.MaxPooling2D((2, 2)))
    model.add(layers.Conv2D(16, (5, 5), activation='relu'))
    model.add(layers.MaxPooling2D((2, 2)))
    model.add(layers.Flatten())
...
def lenet3(in_dim=1, n_class=10):
    model = models.Sequential()
    model.add(layers.Conv2D(32, (3, 3), activation='relu', padding='same', input_shape=(32, 32, in_dim)))
    model.add(layers.MaxPooling2D((2, 2)))
    model.add(layers.Conv2D(64, (3, 3), activation='relu'))
    model.add(layers.MaxPooling2D((2, 2)))
    model.add(layers.Conv2D(64, (3, 3), activation='relu'))    
...
~~~python
print("-"*50 + "\n创建模型") 
model = lenet2(in_dim=3, n_class=10)
