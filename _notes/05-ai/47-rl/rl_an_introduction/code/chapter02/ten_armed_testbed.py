...
def figure_2_1(show=False):
    ...
    plt.violinplot(dataset=np.random.randn(200, 10) + q, showmeans=False)
...
def figure_2_2(runs=2000, time=1000, show=False):
    epsilons = [0, 0.1, 0.01]
...
def figure_2_3(runs=2000, time=1000, show=False):
    bandits = []
...
def figure_2_4(runs=2000, time=1000, show=False):
    bandits = []
...
def figure_2_5(runs=2000, time=1000, show=False):
    bandits = []
...
def figure_2_6(runs=2000, time=1000, show=False):
