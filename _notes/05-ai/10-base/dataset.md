...
<img src="images/examples_new.png" alt="img" style="zoom: 41%;" />     <img src="images/32x32eg.png" alt="img" style="zoom:88%;" />      
...
- 格式一： 是原始未经处理的街景中的房屋号，每张图片包含多个数字，见上面左边的图片。数据文件如下。
...
- 格式二：每张图片代表一个从0-9的数，见上面右边的图片。数据文件如下。
...
def extract_digit_struct(data_path, n=1):    
    digit_file = os.path.join(data_path, 'digitStruct.mat')
...
![image-20201122130442713](images/image-20201122130442713.png)

然后显示图片，并在图片上把识别的方框画上。
...
![image-20201122130526877](images/image-20201122130526877.png)
