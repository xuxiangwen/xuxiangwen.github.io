...
Box-Cox变换是Box和Cox在1964年提出的一种广义幂变换方法，是统计建模中常用的一种数据变换，用于连续的响应变量不满足正态分布的情况。Box-Cox变换之后，可以一定程度上减小不可观测的误差和预测变量的相关性。原来的描述，参见[数据变换的万能钥匙：Box-Cox变换](https://www.sohu.com/a/137884507_278472)， [数据骚操作（二）：偏度和Box Cox转换](https://zhuanlan.zhihu.com/p/53288624)。
$$
y(\lambda)=
\left\{
\begin{aligned}
