...
\item
  \texttt{asciidoc}
  (\href{http://www.methods.co.nz/asciidoc/}{AsciiDoc}) or
...
\texttt{pdfroff}. The default is \texttt{pdflatex}. If the engine is not
...
\hypertarget{structural-variables}{%
\subsection{Structural variables}\label{structural-variables}}
...
\item
  ...
  \texttt{-\/-variable} flag, simply omit a value for the variable, e.g.
  \texttt{-\/-variable\ draft}).
\end{itemize}
...
than \texttt{-} and \texttt{\_} are removed.
