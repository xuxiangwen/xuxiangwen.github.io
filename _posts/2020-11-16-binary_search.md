...
![image-20201115170439599](/assets/images/image-20201115170439599.png)
...
![image-20201116105950726](/assets/images/image-20201116105950726.png)
...
4. 把所有目录恢复到初始样式，然后对于当前内容所在的目录，添加一个特别样式。
